...
**Bode** is a local CLI (v0.17.0) that orchestrates AI coding work through configurable phases (planning, implementation, review, PR creation), driving native AI CLIs interactively (terminal handoff) and syncing progress to Jira. See `SPEC.md` for full requirements. See `CONVENTIONS.md` for code standards.
